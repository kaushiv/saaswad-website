...
<head>
  ...
  <meta name="Description"
		content="If you have any questions, concerns or issues, we're here to help. Contact Us to find the answers to your questions here and get in touch with us if you need to.">
	<meta name="keywords" content="Contact us saaswad heat , get in touch with us, visit us saaswad heat, believe in joint ventures">
...
>>>>>>> 6e096321465679a1612910d055ef3f61e859ec28
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 pr-lg-5 mb-5 mb-md-0  element-animate">
          <div class="pr-lg-5">
            <h2 class="heading border-bottom mb-4 text-left" style="font-family: 'Raleway', sans-serif;">We believe in joint ventures and to be partners while doing business with you.
            </h2>
            <p>Market today demands heat transfer products to be delivered on time, in spec and to their quality standard. Meeting these requirements, engineering expertise, customer service, manufacturing capabilities, and a get-it-done attitude is needed. With two facilities strategically located in India, Saaswad Heat Transfer And Engineering designs and manufactures heat exchangers, radiators, charge air cooler and oil cooler for over three decades.
            </p>
            
          </div>
        </div>
        <div class="col-md-12 col-lg-6">
          <img class="img-fluid" alt="Responsive image" src="img/coorporate3.jpg" alt=""
            style="width: 560px;height: 405px;">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <h3 class="text-uppercase mb-3"><b>Get In Touch</b></h3>
          <h5 class="mb-3">Email Us At</h5>
          <p class="mb-5"><a href="mailto:marketing@saaswad.com">marketing@saaswad.com</a></p>

          <h5 class="mb-3">Call Us</h5>
          <p class="mb-5">Phone: +91 9336116247</p>

          <h5 class="mb-3">Varanasi Unit</h5>
          <p class="mb-5">B-38/47 PR,Tulsipur, <br>Mahmoorganj,Varanasi, <br> Uttar Pradesh,India-221010
          </p>

          <h5 class="mb-3">Pune Unit</h5>
  ...
  <!-- Map section  -->
	...
	<div class="map-section">
		<div class="container">
			<div class="map-info">
				<center><img src="https://user-images.githubusercontent.com/72786676/95831125-47ed1380-0d56-11eb-8075-31c6b95a89dd.png" height="50" alt="" style="background-color: white;" /> </center>
				<p>
					<ul class="text-white">

            <p><span>&#8226;</span>  SITUATED ON NH 19. EASY AND FAST TRANSPORTATION BY ROAD.</p>
                <p><span>&#8226;</span>  18.8 KM FROM VARANASI CITY CENTRE.</p>

                <p><span>&#8226;</span>  25 KM FROM VARANASI AIRPORT.</p>
                <p><span>&#8226;</span>  16 KM FROM Diesel Locomotive Works (DLW).</p>
                <p><span>&#8226;</span>  17 KM FROM CITY RAILWAY STATION.</p>
		...
		<div class="map">
			<iframe
				src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14431.335669906885!2d82.806947!3d25.2761718!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x1ef670a29d928d79!2sSaaswad%20Heat%20Transfer%20%26%20Engineering%20Pvt%20Ltd!5e0!3m2!1sen!2sin!4v1595953386355!5m2!1sen!2sin"
		...
		<div class="row">
          ...
          <div class="team-member">
            <div class="member-info">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d901.7580573579585!2d82.97673382918904!3d25.303121211428774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDE4JzExLjIiTiA4MsKwNTgnMzguMiJF!5e0!3m2!1sen!2sin!4v1596130190474!5m2!1sen!2sin"
			...
			<div class="col-md-6">
				<div class="team-member">
					<div class="member-info">
                        ...
                        <div class="map-container-5">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3778.4387776008934!2d73.8533273145888!3d18.733928067504312!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTjCsDQ0JzAyLjEiTiA3M8KwNTEnMTkuOSJF!5e0!3m2!1sen!2sin!4v1596130728365!5m2!1sen!2sin"
							width="500" height="450" frameborder="0" style="border:0;" allowfullscreen=""
							aria-hidden="false" tabindex="0"></iframe>
						</div>
					</div>
  ...
  <section class="cta-section" style="background-color: #e60000;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 align-items-center">
					<h1 class="text-center" style="color: white; padding-bottom: 2%;">
...
<footer class="site-footer" role="contentinfo" style="background-color: #000000b3;padding: 4em 0 0.5em 0;">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <h3 class="text-white" style="font-size: large;">Contact Us</h3>
          <ul class="list-unstyled footer-link">
            ...
            <li><span class="mr-3 d-block">Phone:</span><span class="text-white" style="font-family: Montserrat;">+91
                9336116247</span></li>
            <li><span class="mr-3 d-block">E-mail:</span><span class="text-white">info@saaswad.com</span></li>
          </ul>
        </div>
      </div>
