...
<html lang="en">
  <head>
    <title>Our Team | Saaswad Heat Transfer and Engineering Pvt. Ltd.</title>
    <meta charset="utf-8">
    <meta name="description"
    content="We are a team because we respect, trust & care for each other. Our greatest strength is our team spirit & that will remain because a core of us come through the leagues together. Their skills and vast experiences enhance the quality of our environment and make SHTE a great place to work. " />
  <meta name="keywords" content="saaswad team, people at saaswad, staff at saaswad, work at saaswad" />
  ...
  <h1 style="position: relative; top: 20rem; color: white; font-size: 10vh; padding-left: 5%; font-weight: 900; margin-left: 3rem;opacity: 0.6;">Our People</h1>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="padding-top: 1%;">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" style="color: #000000b3; outline: none;" id="team-tab" data-bs-toggle="tab" data-bs-target="#team" type="button" role="tab" aria-controls="team" aria-selected="true"><a class="aa" href="#">Our Team</a></button>
      </li>
      <li class="nav-item" role="presentation">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" style="color: #000000b3; outline: none;" id="wspace-tab" data-bs-toggle="tab" data-bs-target="#wspace" type="button" role="tab" aria-controls="wspace" aria-selected="false"><a class="aa" href="#">Workspace</a></button>
      </li>
    </ul>
...
<!-- END OF TESTIMONIALS -->
  ...
  <div class="row justify-content-center element-animate"> 
    ...
    <div class="col-md-1"><p><a href="services.html" class="btn btn-danger">Know More</a></p></div>
      ...
      <div class="tab-pane fade show " id="wspace" role="tabpanel" aria-labelledby="wspace-tab">
